//
// Keymap for the Baluchi (UniBal) keyboard layout
// Based on the UniBal specification by https://www.facebook.com/BalochiLanguage
//
// Created: 2015-09-19 
// Author: by Junaid Qadir Shekhanzai <shekhanzai.baloch@gmail.com>
// Version: 2.0.0
//
...
xkb_symbols "basic" {
    ...
    name[Group1]= "Baluchi (UniBal)";

    key <TLDE> {	[     grave,	asciitilde	]	};
    key <AE01> {	[	  1,	exclam 		]	};
    key <AE02> {	[	  2,	at		]	};
    key <AE03> {	[    eacute,	Eacute,	  3,	numbersign	]	};
    key <AE04> {	[    racute,	Racute,	  4,	dollar		]	};
    key <AE05> {	[    tslash, 	Tslash,  5,	percent		]	};
    key <AE06> {	[	  6,	asciicircum	]	};
    key <AE07> {	[    uacute,	Uacute,	  7,	ampersand	]	};
    key <AE08> {	[    iacute, 	Iacute,	  8,	asterisk	]	};
    key <AE09> {	[    oacute, 	Oacute,	  9,	parenleft	]	};
...
xkb_symbols "euro" {
    ...
    include "bal(basic)"
    name[Group1]= "Baluchi (with euro on 5)";
...
xkb_symbols "intl" {
    ...
    include "bal(basic)"
    name[Group1]= "Baluchi (international with dead keys)";
...
// Based on symbols/bal_intl keyboard map:
...
xkb_symbols "alt-intl" {
  ...
  include "bal"
  name[Group1]= "Baluchi (US, alternative international)";
...
// Reproduce the per-key mapping of bal(intl) for the dvorak layout
// aka "I just swapped my keys over"
partial alphanumeric_keys
xkb_symbols "dvorak-intl" {

    include "bal(dvorak)"
    name[Group1]= "Baluchi (Dvorak, international with dead keys)";
...
xkb_symbols "dvorak-alt-intl" {
    ...
    include "bal(dvorak)"
    name[Group1]= "Baluchi (Dvorak alternative international no dead keys)";
...
xkb_symbols "dvorak-l" {
    ...
    include "bal(dvorak)"
    name[Group1]= "Baluchi (left handed Dvorak)";
...
xkb_symbols "dvorak-r" {
    ...
    include "bal(dvorak)"
    name[Group1]= "Baluchi (right handed Dvorak)";
...
xkb_symbols "dvorak-classic" {
    ...
    name[Group1]= "Baluchi (classic Dvorak)";
...
xkb_symbols "dvp" {
    ...
    include "bal(dvorak)"
    name[Group1] = "Baluchi (programmer Dvorak)";
...
// level3 modifier is a shortcut to the "bal" meaning of the keys where
...
xkb_symbols "altgr-intl" {
   ...
   include "bal(intl)"
   name[Group1]= "Baluchi (international AltGr dead keys)";
...
//
// The keyboard layouts below maps the bal(basic), bal(intl) and bal(alt-intl)
...
// classmate-alt-intl - bal(alt-intl)
// RCTL is generated by Fn+Alt, because that, when trying to access
// the level3 symbols at 7,8,9,0,u,i,o,p,j,k,l,;,m,. and / we got
// the keypad keycodes. The keypad is changed to make Fn+Alt+<KP_key>
// generate the same symbol as the original key.
...
// classmate-altgr-intl - bal(altgr-intl)
// RCTL is generated by Fn+Alt, because that, when trying to access
// the level3 symbols at 7,8,9,0,u,i,o,p,j,k,l,;,m,. and / we got
// the keypad keycodes. The keypad is changed to make Fn+Alt+<KP_key>
// generate the same symbol as the original key.
...
xkb_symbols "olpc" {
   ...
   // OLPC international US Baluchi keyboard layout.
   // It's a little different from the usual international layout.
   // See: http://wiki.laptop.org/go/Image:Keyboard_Baluchi.png
...
xkb_symbols "olpc2" {
   include "bal(olpc)"
   name[Group1]= "Baluchi (the divide/multiply keys toggle the layout)";
   include "group(olpc)"
};
...
xkb_symbols "olpcm" {
   ...
   // Mechanical (non-membrane) OLPC int'l US Baluchi keyboard layout.
   // See: http://wiki.laptop.org/go/OLPC_Baluchi_Non-membrane_Keyboard
...
xkb_symbols "workman-intl" {
    ...
    include "bal(intl)"
    name[Group1]= "Baluchi (Workman, international with dead keys)";
...
// XCompose is out! Unicode combining is in!  For those of bal who live
...
// something on screen.
//
// TODO: as of now, this duplicates all bal(intl) functionality with
// combining.  With care, perhaps we could add more combining marks
// not present in intl, and support all major languages.
partial alphanumeric_keys
xkb_symbols "intl-unicode" {

 name[Group1]= "Baluchi (US, international AltGr Unicode combining)";
...
// XCompose is out! Unicode combining is in! For those of bal who live
// on the edge: A keymap using Unicode combining characters instead of
// deadkeys. This variation does break compatibility with bal-intl,
// whenever I thought it would be more mnemonic or Unicodeish.
partial alphanumeric_keys
xkb_symbols "alt-intl-unicode" {

 name[Group1]= "Baluchi (US, international AltGr Unicode combining, alternative)";

 include "bal(intl-unicode)"
...
partial alphanumeric_keys
	...
	include "sun_vndr/bal(sun_type6)"
};
